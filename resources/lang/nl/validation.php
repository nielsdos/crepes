...
return [
    ...
    'max_length_error' => 'Dit veld moet tussen de 1 en :length karakters lang zijn.',
    'custom' => [
        'g-recaptcha-response' => [
            'required' => 'Gelieve te verifiëren dat u geen robot bent.',
            'captcha' => 'Captcha error! Probeer later opnieuw of contacteer een beheerder indien het probleem blijft.',
        ],
    ],
    'attributes' => [
        'address' => 'adres',
        ...
        'name' => 'naam',
        'password' => 'wachtwoord',
        'password_current_password' => 'huidig wachtwoord',
        'email_current_password' => 'huidig wachtwoord',
